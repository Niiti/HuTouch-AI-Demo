...
class AppColors {
  ...
  static const Color blackColor = Color(0xFF22182A); // #22182A
  static const Color grey400Color = Color(0xFF9E9FAE); // #9E9FAE
  static const Color grey500Color = Color(0xFF6C7180); // #6C7180
  static const Color iconColor = Color(0xFF4B164C); // Same as backgroundColor
...
class AppTextStyles {
  ...
  static const TextStyle subHeaderTextStyle = TextStyle(
    ...
    fontWeight: FontWeight.w600,
    color: AppColors.whiteColor,
    height: 1.5, // Line height of 24
  );

  static const TextStyle senderNameTextStyle = TextStyle(
    fontFamily: 'Hellix-SemiBold',
    fontSize: 18,
    fontWeight: FontWeight.w600,
    color: AppColors.blackColor,
    height: 1.35, // Line height 24.3 (135% of 18)
  );

  static const TextStyle messageSnippetTextStyleUnread = TextStyle(
    fontFamily: 'Hellix-Regular',
    fontSize: 14,
    fontWeight: FontWeight.w400,
    color: AppColors.blackColor,
    height: 1.4, // Line height 19.6 (140% of 14)
  );

  static const TextStyle messageSnippetTextStyleRead = TextStyle(
    fontFamily: 'Hellix-Regular',
    fontSize: 14,
    fontWeight: FontWeight.w400,
